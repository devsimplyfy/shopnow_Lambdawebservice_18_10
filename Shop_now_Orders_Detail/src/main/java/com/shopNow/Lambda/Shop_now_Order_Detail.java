	...
	public JSONObject handleRequest(JSONObject input, Context context) {
		...
		try {
			...
			if ((product_id == 0) && (order_id!=null || order_id != "")) {
				...
				sql11="SELECT * FROM wsimcpsn_shopnow.order_details  INNER JOIN products ON products.id=order_details.productId WHERE order_details.order_id ='"+ order_id + "' and order_details.user_id ='" + userid + "' limit "+(page_number-1)*10 +","+ page_size;
					
				
			}else if(product_id!=0 && userid != 0 && order_id==null){
				
				sql11="SELECT * FROM wsimcpsn_shopnow.order_details  INNER JOIN products ON products.id=order_details.productId WHERE  order_details.user_id ='" + userid + "' and order_details.productId='" + product_id + "'";
			...
			sql11="SELECT * FROM wsimcpsn_shopnow.order_details  INNER JOIN products ON products.id=order_details.productId WHERE order_details.order_id ='"+ order_id + "' and order_details.user_id ='" + userid + "' and order_details.productId='" + product_id + "'";
			...
			jo_CartItem_Result_final.put("billing address",billing_address);
			jo_CartItem_Result_final.put("shipping_address", shipping_address);
